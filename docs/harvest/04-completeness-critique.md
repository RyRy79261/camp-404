...
| `account_deletion_requests` | 1910 | **SKIP — already refuted** | 14-day grace + cancel + partial unique index `WHERE status='pending'`. Ledger row `00-ledger-priority.md:188` is **REFUTED** and the correction stands: Camp 404's irreversible erasure is a *recorded owner decision* (`docs/specs/2026-05-30-account-deletion-design.md` §Decisions). Do not port. |
