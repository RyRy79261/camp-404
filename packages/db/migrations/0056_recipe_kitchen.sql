...
ALTER TABLE "recipe_lessons" ADD CONSTRAINT "recipe_lessons_version_id_recipe_versions_id_fk" FOREIGN KEY ("version_id") REFERENCES "public"."recipe_versions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "recipe_lessons_version_idx" ON "recipe_lessons" USING btree ("version_id");--> statement-breakpoint
...
ALTER TABLE "recipes" ADD CONSTRAINT "recipes_accepted_version_id_recipe_versions_id_fk" FOREIGN KEY ("accepted_version_id") REFERENCES "public"."recipe_versions"("id") ON DELETE set null ON UPDATE no action;