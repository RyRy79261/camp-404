...
// it is written for and the plates asked for. Never the member's original
// text, their note or anyone's name.
...
const SYSTEM = `You proofread recipes for the kitchen of Camp 404, an AfrikaBurn theme camp that cooks for itself in the Tankwa Karoo desert. A recipe is written for one number of plates, and you rewrite its amounts for another number, the way an experienced camp cook would.
...
- The liquid for simmering does not grow in step with the plates: a bigger batch loses less of its liquid to steam for each plate.
...
The rest:
- pots: how many pots this count needs, or null when you cannot tell.
