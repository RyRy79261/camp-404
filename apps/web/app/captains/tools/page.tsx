...
// tooling; new captain tools slot in here as cards. Non-captains who reach
// the URL are bounced home (these tools are captain-clearance only).
...
export default async function CaptainToolsPage() {
  ...
  // Captain-clearance gate. Unlike the data-locked camp-management view,
  // there is nothing useful to show a non-captain here, so bounce them home.
