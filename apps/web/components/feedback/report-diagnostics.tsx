    ...
    >
      ...
      <div id={bodyId} hidden={!open} className="flex flex-col gap-2 px-3 pb-3">
        <p className="text-xs text-muted-foreground">
          This goes on a public GitHub issue. Your name and email are never
          attached — only what you write, these facts about the device
          you&rsquo;re on, and your camp account id, which means nothing outside
          the camp but lets a captain work out who to follow up with.
        </p>
